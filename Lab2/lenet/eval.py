...
if __name__ == "__main__":
    ...
    #如果要用train训练得到的model，此处要把default补齐
    parser.add_argument('--ckpt_path', type=str, default="C:/Users/admin/Desktop/Introduction to Artificial Intelligence/Lab2/lenet/ckpt/checkpoint_lenet-10_1875.ckpt", help='if mode is test, must provide\
